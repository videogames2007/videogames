                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="num_doc_cliente ">Numero Documento</label>
                                    <input type="text" class="form-control" require name="num_doc_cliente " id="num_doc_cliente " placeholder="Documento" value="<?php echo $num_doc_cliente  ?>">
                                    <br>
                                </div>
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td> <?php echo $cliente['num_doc_cliente ']        ?> </td>
