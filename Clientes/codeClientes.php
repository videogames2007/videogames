...
$num_doc_cliente  = (isset($_POST['num_doc_cliente '])) ? $_POST['num_doc_cliente '] : "";
...
switch ($accion) {
    case 'btnAgregar':
                ...
                */
                ...
                "INSERT INTO cliente (num_doc_cliente , nombre_cliente, apellido_cliente, telefono_cliente,direccion_cliente) 
...
$consultaClientes = $conn->prepare("SELECT * FROM cliente");
